<template>
	<div class="grid">
		...
		<BaseInputFileImagePreview
			...
			:max-file-size-mb="1"
		/>
		<quickSlider v-model="size" min="50" max="1000"></quickSlider>
		<p>Sample Text Below the Upload Test Test</p>
	</div>
</template>
...
const text = ref('55')
const tex = ref(true)
const supportingText = computed(() => (tex.value ? 'Invalid Login' : null))
